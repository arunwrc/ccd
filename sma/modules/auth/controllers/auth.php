...
class Auth extends MX_Controller {
	...
	function edit_user($id = NULL)
	{
		...
		$this->form_validation->set_rules('phone', $this->lang->line("phone"), 'required|xss_clean|min_length[9]|max_length[16]');
		//
		//$this->form_validation->set_rules('warehouse', $this->lang->line("warehouse"), 'xss_clean');
		//
		...
		{ //display the create user form
			...
			//
			//$data['warehouse'] => $this->form_validation->set_value('warehouse');
			/*$data['warehouse'] = array('name' => 'company',
				'id' => 'company',
				'type' => 'text',
				'value' => $this->form_validation->set_value('warehouse'),
			);*/
			//
			$data['phone'] = array('name' => 'phone',
				'id' => 'phone',
