...
class Pos_model extends CI_Model
{
    ...
    public function fetch_products($category_id, $limit, $start) {
		...
		$this->db->join('settings', 'warehouses_products.warehouse_id = settings.default_warehouse', 'left');
		...
		$this->db->where('warehouses_products.warehouse_id = settings.default_warehouse');
		$this->db->group_by("code", "asc"); 
        $query = $this->db->get("products"); //$qry=$this->db->last_query();// print_r($qry); exit;
